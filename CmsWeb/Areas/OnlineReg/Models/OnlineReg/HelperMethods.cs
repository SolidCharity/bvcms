...
<div class=""instructions sorry"">{setting.InstructionSorry}</div>";
        ...
        public string YouMustAgreeStatement(int? orgid) => Util.PickFirst(Organization.GetExtra(CurrentDatabase, orgid, "YouMustAgreeStatement"), "<p>You must agree to the terms above for you or your minor child before you can continue with confirmation.</p>");
        ...
        public static OnlineRegModel GetRegistrationFromDatum(int id, CMSDataContext db)
        {
            ...
            try
            {
                ...
                m.CurrentDatabase = db; // setting db here since this is basically another form of a constructor based on current usage
                return m;
            }
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        public void DebugCleanUp()
        {
            var q = from om in CurrentDatabase.OrganizationMembers
                    where new[] { 828612, Util.UserPeopleId }.Contains(om.PeopleId) //todo: what/who does the 828612 represent?
